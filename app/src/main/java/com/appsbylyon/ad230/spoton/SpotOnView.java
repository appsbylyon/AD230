...
public class SpotOnView extends View
{
    ...
    public void resetGame()
    {
        ...
        for (int i = 0; i < LIVES; i++)
        {
            ...
            livesLinearLayout.addView(
                    (ImageView) layoutInflater.inflate(R.layout.spoton_life, null));
        } // end for
    ...
    private void displayScores()
    {
        ...
        highScoreTextView.setText(
                resources.getString(R.string.spot_on_high_score) + " " + highScore);
        currentScoreTextView.setText(
                resources.getString(R.string.spot_on_score) + " " + score);
        levelTextView.setText(
                resources.getString(R.string.spot_on_level) + " " + level);
    ...
    public void addNewSpot()
    {
        ...
        final ImageView spot =
                (ImageView) layoutInflater.inflate(R.layout.spoton_untouched, null);
    ...
    public void missedSpot(ImageView spot)
    {
        ...
        if (livesLinearLayout.getChildCount() == 0)
        {
            ...
            dialogBuilder.setTitle(R.string.spot_on_game_over);
            dialogBuilder.setMessage(resources.getString(R.string.spot_on_score) +
                    " " + score);
            dialogBuilder.setPositiveButton(R.string.spot_on_reset_game,
