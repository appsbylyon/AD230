        ...
        implements SurfaceHolder.Callback
{
    ...
    private void updatePositions(double elapsedTimeMS)
    {
                    ...
                    cannonball.y - cannonballRadius < target.end.y)
            {
                        ...
                        !hitStates[section])
                {
                    ...
                    if (++targetPiecesHit == TARGET_PIECES)
                    {
                        ...
                        showGameOverDialog(R.string.cannon_win); // show winning dialog
        ...
        if (timeLeft <= 0.0)
        {
            ...
            gameOver = true; // the game is over
            cannonThread.setRunning(false);
            showGameOverDialog(R.string.cannon_lose); // show the losing dialog
        } // end if
    ...
    public void drawGameElements(Canvas canvas)
    {
        ...
        canvas.drawText(getResources().getString(
                R.string.cannon_time_remaining_format, timeLeft), 30, 50, textPaint);
    ...
    private void showGameOverDialog(int messageId)
    {
        ...
        dialogBuilder.setMessage(getResources().getString(
                R.string.cannon_results_format, shotsFired, totalElapsedTime));
        dialogBuilder.setPositiveButton(R.string.cannon_reset_game,
